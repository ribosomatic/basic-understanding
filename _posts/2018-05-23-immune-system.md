...
The immune system relies heavily on the _lymphatic system_ and its organs such as the _spleen_ and _thymus_, and the _lymph nodes_. _Bone marrow_ produces most cells of the immune system. The _skin_ acts as a barrier isolating the body from the external pathogens. In addition, _mucous membranes_ of all body openings to the outside act as specialized checkpoints. Other parts of the body associated with the immune system include the _tonsils_, _adenoids_, parts of the small intestine and _appendix_.
  ...
  - Lymphoid aggregates
    ...
    These are spread out across the body in locations that get exposed to a lot of foreign substances. Like the lymph nodes, the goal is to get antigens in contacts with lymphocytes. The main types are:
...
_Macrophages_ ("large eaters") are larger cells that can also phagocytize invading pathogens, and release cytokines to attract other immune cells. They can also process antigens and present them to T-cells for activation of an adaptive immune response.
Other cells of the innate immune system that are recruited include _basophils_, _eosinophils_ and _mast cells_.

<i>Video of macrophages eating pathogens (<a target="_blank" href="https://creativecommons.org/licenses/by/2.5/deed.en" title="Creative Commons Attribution 2.5">CC BY 2.5</a>, <a target="_blank" href="https://commons.wikimedia.org/w/index.php?title=File%3AS3-Alveolar_Macrophages_with_Conidia_in_Liquid_Medium.ogv">Link</a>)</i>

> How do macrophages and granulocytes recognize pathogens?
>> They have different pattern recognition receptors that bind to molecules typically found on microbes and other foreign substances. One type is the Toll-like receptor (TLR) which is mostly responsible for detecting extracellular pathogens (e.g. bacteria). Another one is the NOD-like receptor (NLR) which recognizes intracellular pathogens in the cytosol.

In the case of a viral infection some of the body's own cells have been hijacked by the virus which is using them to replicate itself. In those cases the immune system natural killer (NK) cells can recognize which cells are in distress and execute them by releasing different molecules at close proximity. Perforins cause the formation of pores into the target cells and granzymes enter the cells via those pores and can trigger lysis (rupture of the cell wall) or apoptosis (programmed cell death).

> How do NK cells know which cells to attack?
>> They have special receptors called killer-cell inhibitory receptors (KIRs) which bind to MHC molecules which normally exist on the surface of all cells. Diseased cells (virus-infected or tumor cells) have fewer MHC molecules and cannot bind properly to the KIRs to inhibit the activation of the NK cells.

> What's MHC?
>> MHC stands for _major histocompatibility complex_ and is a family of surface proteins which are present on all cells of the body and are responsible for tissue compatibility. Cells break down peptides present in their cytosol and present pieces of them on their surface attached to their MHC receptors. It's like a window into the cell and a way for the immune system (T cells) to quickly examine different cells. If the presented peptide is foreign it will trigger a cytotoxic response from T cells. If MHC molecules are missing (or reduced) it will trigger a response from NK cells. In humans MHC is also referred to as HLA (human leukocyte antigen).

> What's the difference between lysis and apoptosis?
>> _Lysis_ simply causes the cell to rupture and spill out its entire contents causing an inflammatory reaction in the area and requires cleanup by macrophages. It is rarely the desired outcome, especially in the case of a virally infected cell which is going to release all viral particles when it ruptures. _Apoptosis_, on the other hand, triggers internal mechanisms to cleanly shut down the cell, recycling all internal parts and destroying any virions.

The next step of the immune response involves B and T cells which target very specific parts of the invading pathogen, called antigen. This is the acquired part of immunity which involves the production of antibodies and needs input from the innate system. When macrophages and dendritic cells digest pathogens they display parts of them (as peptides) on their surface and travel to the lymph nodes where they can get in close contact with lymphocytes. Any naive T cells that have matching receptors (TCRs) for the presented peptide become activated and start multiplying. At the same time, naive B cells that get in touch with a matching antigen become activated _if_ they also get a co-stimulatory signal from a helper T cell. Those B cells start multiplying and produce plasma cells which start secreting millions of antibodies. This process takes about 4-5 days, compared to minutes for the innate non-specific response. The antibodies (which are just proteins that stick to their matching antigen) circulate in the blood (especially to sites of inflammation) and tag the pathogen by forming antigen-antibody complexes. They don't actually do anything to kill it but they can slow it down by clumping multiple pathogens together. The release of cytokines activates the classical pathway of the complement system which ruptures the cell walls of the microorganisms and attracts more macrophages. In addition, the activated T cells seek out and destroy more of the offenders by lysis. This is similar to how the NK cells operate but is much more specific - e.g. the T cells could attack a specific kind of bacteria but skip another one, even if it's very similar, because it doesn't match its TCR.

The immune response eventually winds down and the B and T lymphocytes die but a few memory cells are left behind and can live for a long time (years). Next time the same pathogen is encountered, the secondary response is much faster and stronger.

## Types of lymphocytes

TODO: B and T cell subtypes, CDs
